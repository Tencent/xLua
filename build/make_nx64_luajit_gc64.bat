...
rem deinfe LUAJIT_USE_SYSMALLOC as no mmap for switch
...
set "LUAJIT_CFLAGS=\"-DLJ_TARGET_CONSOLE -DLUAJIT_USE_SYSMALLOC -DLJ_TARGET_PS4 -DLUAJIT_DISABLE_JIT -DLUAJIT_ENABLE_GC64 -DLUAJIT_DISABLE_FFI\""
bash -c "make clean"
