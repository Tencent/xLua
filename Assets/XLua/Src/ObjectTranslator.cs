...
#pragma warning restore 414
    ...
    public partial class ObjectTranslator
	{
        ...
        Delegate getDelegate(DelegateBridgeBase bridge, Type delegateType)
        {
            ...
            var methods = bridge.GetType().GetMethods(BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly).Where(m => !m.IsGenericMethodDefinition && m.Name.StartsWith("__Gen_Delegate_Imp")).ToArray();
